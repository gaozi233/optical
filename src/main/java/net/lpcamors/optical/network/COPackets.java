...
public enum COPackets {
    ...
    CONFIGURE_HOLOGRAM(ConfigureHologramSourcePacket.class, ConfigureHologramSourcePacket::new,
            NetworkDirection.PLAY_TO_SERVER),
    CONFIGURE_OPTICAL_SOURCE(ConfigureOpticalSourcePacket.class, ConfigureOpticalSourcePacket::new,
            NetworkDirection.PLAY_TO_CLIENT);

    public static final ResourceLocation CHANNEL_NAME = CreateOptical.loc("main");
